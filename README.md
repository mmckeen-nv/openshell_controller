...
- NemoClaw source ref: `v0.0.66` (`NEMOCLAW_INSTALL_REF=v0.0.66`)
...
That helper defaults to `OPENSHELL_VERSION=v0.0.44`, `NEMOCLAW_INSTALL_REF=v0.0.66`, and `OPENCLAW_VERSION=2026.5.27`.
