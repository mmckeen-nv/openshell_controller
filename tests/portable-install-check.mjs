...
assert.match(versionedInstallSource, /OPENSHELL_VERSION="\$\{OPENSHELL_VERSION:-v0\.0\.101\}"/, 'versioned installer must default to the OpenShell release supported by current NemoClaw main')
