...
assert.match(deleteRouteSource, /Skipped NemoClaw registry cleanup/, 'delete route must not pass UUID-style refs into NemoClaw cleanup')
...
assert.match(sandboxInferenceApplyLibSource, /name: route\.model/, 'live apply must keep model display names raw while primary refs remain provider-qualified')
